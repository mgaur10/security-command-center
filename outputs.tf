...
output "_02_iap_ssh_gke_proxy" {
  value = "gcloud compute ssh --zone ${var.network_zone} ${google_compute_instance.kubernetes_proxy_server1.name}  --tunnel-through-iap --project ${google_project.demo_project.project_id}"
 }
